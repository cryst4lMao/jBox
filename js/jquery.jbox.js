/*!
  ...
  @homepage http://github.com/iancj/jbox
*/
...
;(function($, document,window ) {
  ...
  function _extendOpts( newOpts ){
    ...
    opts = $.extend( {}, $.jBox.setting, newOpts );//合并所有参数
    opts_btnok = $.extend({}, $.jBox.setting.btnOK, newOpts.btnOK);//合并确定按钮参数
    opts_btncancel = $.extend({}, $.jBox.setting.btnCancle, newOpts.btnCancle);//合并取消按钮参数
  ...
  publicmethod.show = function(options) {
    var opts = $.extend({}, $.jBox.setting ,options),
        newBox=new JBox({
          title:opts.title,
  ...
  // fixed!
  function log() {
    publicmethod.log.apply( $.jBox, arguments );
  }
